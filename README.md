...
Indicaciones para lenvatar el Backend:
    ...
    fastapi uvicorn sqlalchemy  pydantic    python-jose[cryptography]   passlib[bcrypt] python-multipart
...
Indicaciones para lenvatar la App:
    ...
    2.Seleccionar el dispositivo en el que se probará la app.
    3.Ya ubicado y con en dispositivo seleccionado ejecutar en consola: flutter run
        (alternativa: presionar F5)
